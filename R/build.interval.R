#'Joining Multiple Intervals
#'
#'The function builds the multi split interval for a given x0 in each point of the
#'evaluation
...
#'@details The function returns a single interval for a single point in x0.
#'@noRd
